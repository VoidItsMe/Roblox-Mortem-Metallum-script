# Roblox-Mortem-Metallum-script
This is my first gui script, I hope you like this script. In the future, the script will be updated.
Script:
local Library = loadstring(game:HttpGet("https://raw.githubusercontent.com/xHeptc/Kavo-UI-Library/main/source.lua"))()
local Window = Library.CreateLib("Mortem Destroyer", "BloodTheme")
local Tab = Window:NewTab("Main")
local Section = Tab:NewSection("Main")
Section:NewButton("Anti kick Bypass", "This feature includes anti kick", function()
...
Section:NewButton("Crossbow Dupe", "The function will spawn a lot of crossbows in your inventory", function()
local plr = game.Players.LocalPlayer
local dupe = {}
for i=1,50 do table.insert(dupe,tonumber(12)) end -- IF YOU WANT MORE THAN 80 GRENADES, CHANGE THE (80) TO WHATEVER NUMBER
...
if v.Name == "Grenade" or v.Name == "Fire bomb" or v.Name == "Bear trap" or v.Name == "C4" then
v:Destroy()
end
end
    print("Clicked")
end)
Section:NewButton("Crossbow Minigun", "G-Reload all, T-Minigun, C-3 shoots V-Shot with all arrows", function()
local plr = game.Players.LocalPlayer
...
Section:NewSlider("Movement", "This feature will allow you to move faster", 100, 0, function(s)
    game.Players.LocalPlayer.Character.Humanoid.WalkSpeed = s
end)
Section:NewButton("Infinite Jump", "G To toggle", function()
_G.infinjump = true
...
Section:NewSlider("JumpPower", "The function allows you to jump higher", 500, 0, function(j)
    game.Players.LocalPlayer.Character.Humanoid.JumpPower = j
end)

local Tab = Window:NewTab("Mics")
local Section = Tab:NewSection("Funny Features")
Section:NewButton("Destroy Limbs", "Destroys your body parts", function()
...
Section:NewButton("Infinite Yield", "The function gives you admin commands", function()
loadstring(game:HttpGet(('https://raw.githubusercontent.com/EdgeIY/infiniteyield/master/source'),true))()
    print("Clicked")
end)
Section:NewButton("Wall walk", "The function will allow you to walk on the walls", function()
--[[
...
Section:NewButton("Rejoin", "Rejoin to the server", function()
loadstring(game:HttpGet("https://pastebin.com/raw/1gtVMUz3"))()
    print("Clicked")
end)
Section:NewButton("Server hop", "The function connects you to a random server", function()
...
Section:NewLabel("All scripts are checked, there will be no ban")
Section:NewLabel("Script Version:1.1")
Section:NewLabel("Creator: Demogorgon#7727")
